...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createAccount(CreateAccountRequest payload, map<string|string[]> headers = {}) returns ApiV2010Account|error {
        string resourcePath = string `/Accounts.json`;
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchAccount(string sid, map<string|string[]> headers = {}) returns ApiV2010Account|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateAccount(string sid, UpdateAccountRequest payload, map<string|string[]> headers = {}) returns ApiV2010Account|error {
        string resourcePath = string `/Accounts/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createAddress(string accountSid, CreateAddressRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountAddress|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Addresses.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchAddress(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountAddress|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateAddress(string accountSid, string sid, UpdateAddressRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountAddress|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Addresses/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createApplication(string accountSid, CreateApplicationRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountApplication|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Applications.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchApplication(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountApplication|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateApplication(string accountSid, string sid, UpdateApplicationRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountApplication|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Applications/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchAuthorizedConnectApp(string accountSid, string connectAppSid, map<string|string[]> headers = {}) returns ApiV2010AccountAuthorizedConnectApp|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchAvailablePhoneNumberCountry(string accountSid, string countryCode, map<string|string[]> headers = {}) returns ApiV2010AccountAvailablePhoneNumberCountry|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchBalance(string accountSid, map<string|string[]> headers = {}) returns ApiV2010AccountBalance|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createCall(string accountSid, CreateCallRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCall|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchCall(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountCall|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateCall(string accountSid, string sid, UpdateCallRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCall|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchCallNotification(string accountSid, string callSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountCallCallNotificationInstance|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createCallRecording(string accountSid, string callSid, CreateCallRecordingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallCallRecording|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Recordings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchCallRecording(string accountSid, string callSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountCallCallRecording|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateCallRecording(string accountSid, string callSid, string sid, UpdateCallRecordingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallCallRecording|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Recordings/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchConference(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountConference|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateConference(string accountSid, string sid, UpdateConferenceRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountConference|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchConferenceRecording(string accountSid, string conferenceSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountConferenceConferenceRecording|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateConferenceRecording(string accountSid, string conferenceSid, string sid, UpdateConferenceRecordingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountConferenceConferenceRecording|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Recordings/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchConnectApp(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountConnectApp|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateConnectApp(string accountSid, string sid, UpdateConnectAppRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountConnectApp|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/ConnectApps/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumber(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumber|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateIncomingPhoneNumber(string accountSid, string sid, UpdateIncomingPhoneNumberRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumber|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createIncomingPhoneNumber(string accountSid, CreateIncomingPhoneNumberRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumber|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumberAssignedAddOn(string accountSid, string resourceSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createIncomingPhoneNumberAssignedAddOn(string accountSid, string resourceSid, CreateIncomingPhoneNumberAssignedAddOnRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/${getEncodedUri(resourceSid)}/AssignedAddOns.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumberAssignedAddOnExtension(string accountSid, string resourceSid, string assignedAddOnSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createIncomingPhoneNumberLocal(string accountSid, CreateIncomingPhoneNumberLocalRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/Local.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createIncomingPhoneNumberMobile(string accountSid, CreateIncomingPhoneNumberMobileRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/Mobile.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createIncomingPhoneNumberTollFree(string accountSid, CreateIncomingPhoneNumberTollFreeRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/TollFree.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchKey(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountKey|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateKey(string accountSid, string sid, UpdateKeyRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountKey|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Keys/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createNewKey(string accountSid, CreateNewKeyRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountNewKey|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Keys.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchMedia(string accountSid, string messageSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountMessageMedia|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchMember(string accountSid, string queueSid, string callSid, map<string|string[]> headers = {}) returns ApiV2010AccountQueueMember|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateMember(string accountSid, string queueSid, string callSid, UpdateMemberRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountQueueMember|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Queues/${getEncodedUri(queueSid)}/Members/${getEncodedUri(callSid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createMessage(string accountSid, CreateMessageRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountMessage|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Messages.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchMessage(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountMessage|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateMessage(string accountSid, string sid, UpdateMessageRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountMessage|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Messages/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createMessageFeedback(string accountSid, string messageSid, CreateMessageFeedbackRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountMessageMessageFeedback|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createNewSigningKey(string accountSid, CreateNewSigningKeyRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountNewSigningKey|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SigningKeys.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchNotification(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountNotificationInstance|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchOutgoingCallerId(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountOutgoingCallerId|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateOutgoingCallerId(string accountSid, string sid, UpdateOutgoingCallerIdRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountOutgoingCallerId|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/OutgoingCallerIds/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createValidationRequest(string accountSid, CreateValidationRequestRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountValidationRequest|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/OutgoingCallerIds.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchParticipant(string accountSid, string conferenceSid, string callSid, map<string|string[]> headers = {}) returns ApiV2010AccountConferenceParticipant|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateParticipant(string accountSid, string conferenceSid, string callSid, UpdateParticipantRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountConferenceParticipant|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Participants/${getEncodedUri(callSid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createParticipant(string accountSid, string conferenceSid, CreateParticipantRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountConferenceParticipant|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Participants.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createPayments(string accountSid, string callSid, CreatePaymentsRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallPayments|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    remote isolated function updatePayments(string accountSid, string callSid, string sid, UpdatePaymentsRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallPayments|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchQueue(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountQueue|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateQueue(string accountSid, string sid, UpdateQueueRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountQueue|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Queues/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createQueue(string accountSid, CreateQueueRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountQueue|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Queues.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createRealtimeTranscription(string accountSid, string callSid, CreateRealtimeTranscriptionRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallRealtimeTranscription|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Transcriptions.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateRealtimeTranscription(string accountSid, string callSid, string sid, UpdateRealtimeTranscriptionRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallRealtimeTranscription|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Transcriptions/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    remote isolated function fetchRecording(string accountSid, string sid, map<string|string[]> headers = {}, *FetchRecordingQueries queries) returns ApiV2010AccountRecording|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchRecordingAddOnResult(string accountSid, string referenceSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountRecordingRecordingAddOnResult|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchRecordingAddOnResultPayload(string accountSid, string referenceSid, string addOnResultSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountRecordingRecordingAddOnResultRecordingAddOnResultPayload|error {
    ...
    remote isolated function fetchRecordingAddOnResultPayloadData(string accountSid, string referenceSid, string addOnResultSid, string payloadSid, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Recordings/${getEncodedUri(referenceSid)}/AddOnResults/${getEncodedUri(addOnResultSid)}/Payloads/${getEncodedUri(payloadSid)}/Data.json`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchRecordingTranscription(string accountSid, string recordingSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountRecordingRecordingTranscription|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchShortCode(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountShortCode|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateShortCode(string accountSid, string sid, UpdateShortCodeRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountShortCode|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SMS/ShortCodes/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSigningKey(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSigningKey|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSigningKey(string accountSid, string sid, UpdateSigningKeyRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSigningKey|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SigningKeys/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipAuthCallsCredentialListMapping(string accountSid, string domainSid, CreateSipAuthCallsCredentialListMappingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Calls/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipAuthCallsCredentialListMapping(string accountSid, string domainSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipAuthCallsIpAccessControlListMapping(string accountSid, string domainSid, CreateSipAuthCallsIpAccessControlListMappingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Calls/IpAccessControlListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipAuthCallsIpAccessControlListMapping(string accountSid, string domainSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipAuthRegistrationsCredentialListMapping(string accountSid, string domainSid, CreateSipAuthRegistrationsCredentialListMappingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Registrations/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipAuthRegistrationsCredentialListMapping(string accountSid, string domainSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipCredential(string accountSid, string credentialListSid, CreateSipCredentialRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialListSipCredential|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(credentialListSid)}/Credentials.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipCredential(string accountSid, string credentialListSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialListSipCredential|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSipCredential(string accountSid, string credentialListSid, string sid, UpdateSipCredentialRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialListSipCredential|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(credentialListSid)}/Credentials/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipCredentialList(string accountSid, CreateSipCredentialListRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialList|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipCredentialList(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialList|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSipCredentialList(string accountSid, string sid, UpdateSipCredentialListRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipCredentialList|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipCredentialListMapping(string accountSid, string domainSid, CreateSipCredentialListMappingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipCredentialListMapping|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipCredentialListMapping(string accountSid, string domainSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipCredentialListMapping|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipDomain(string accountSid, CreateSipDomainRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomain|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipDomain(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomain|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSipDomain(string accountSid, string sid, UpdateSipDomainRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomain|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipIpAccessControlList(string accountSid, CreateSipIpAccessControlListRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlList|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipIpAccessControlList(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlList|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSipIpAccessControlList(string accountSid, string sid, UpdateSipIpAccessControlListRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlList|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipIpAccessControlListMapping(string accountSid, string domainSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipIpAccessControlListMapping|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipIpAccessControlListMapping(string accountSid, string domainSid, CreateSipIpAccessControlListMappingRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipDomainSipIpAccessControlListMapping|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/IpAccessControlListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createSipIpAddress(string accountSid, string ipAccessControlListSid, CreateSipIpAddressRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlListSipIpAddress|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(ipAccessControlListSid)}/IpAddresses.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchSipIpAddress(string accountSid, string ipAccessControlListSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlListSipIpAddress|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSipIpAddress(string accountSid, string ipAccessControlListSid, string sid, UpdateSipIpAddressRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountSipSipIpAccessControlListSipIpAddress|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(ipAccessControlListSid)}/IpAddresses/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createSiprec(string accountSid, string callSid, CreateSiprecRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallSiprec|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateSiprec(string accountSid, string callSid, string sid, UpdateSiprecRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallSiprec|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function createStream(string accountSid, string callSid, CreateStreamRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallStream|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateStream(string accountSid, string callSid, string sid, UpdateStreamRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallStream|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createToken(string accountSid, CreateTokenRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountToken|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchTranscription(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountTranscription|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function fetchUsageTrigger(string accountSid, string sid, map<string|string[]> headers = {}) returns ApiV2010AccountUsageUsageTrigger|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function updateUsageTrigger(string accountSid, string sid, UpdateUsageTriggerRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountUsageUsageTrigger|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Usage/Triggers/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createUsageTrigger(string accountSid, CreateUsageTriggerRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountUsageUsageTrigger|error {
        string resourcePath = string `/Accounts/${getEncodedUri(accountSid)}/Usage/Triggers.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType());
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createUserDefinedMessage(string accountSid, string callSid, CreateUserDefinedMessageRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallUserDefinedMessage|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Created 
    remote isolated function createUserDefinedMessageSubscription(string accountSid, string callSid, CreateUserDefinedMessageSubscriptionRequest payload, map<string|string[]> headers = {}) returns ApiV2010AccountCallUserDefinedMessageSubscription|error {
